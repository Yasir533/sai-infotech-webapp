  ...
  return (
    ...
    <div>
      ...
      <button
        ...
        className="fixed bottom-5 right-24 w-14 h-14 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 text-white shadow-2xl z-50 transform hover:scale-105 transition-all duration-200 flex flex-col items-center justify-center gap-0.5"
      >
      ...
      {open && (
        ...
        <div className="fixed bottom-20 right-20 w-[340px] h-[500px] bg-gradient-to-b from-slate-900 to-slate-800 border border-slate-700 rounded-3xl shadow-2xl overflow-hidden flex flex-col z-50">
