  ...
  return (
    ...
    <div>
      ...
      <button
        ...
        className="fixed bottom-24 right-5 w-14 h-14 rounded-full bg-[#08111f] border border-cyan-400/25 text-cyan-300 text-xl shadow-[0_0_28px_rgba(0,200,255,0.18)] z-50 transform hover:scale-105 transition-all duration-200 flex items-center justify-center"
      >
      ...
      {open && (
        ...
        <div className="fixed bottom-40 right-4 w-[340px] h-[500px] bg-[#06111f] border border-cyan-400/20 rounded-3xl shadow-2xl overflow-hidden flex flex-col z-50">

          {/* HEADER */}
          <div className="flex items-center justify-between px-4 py-3 bg-black/30 border-b border-cyan-400/10">

            <div className="flex items-center gap-3">

              <div className="w-9 h-9 rounded-full bg-[#0066ff] flex items-center justify-center text-white text-sm shadow-[0_0_18px_rgba(0,102,255,0.35)]">
                <FiMessageCircle />
              </div>
          ...
          <div className="p-3 border-t border-slate-700 flex gap-2 bg-gradient-to-t from-transparent to-black/20">
            ...
            <button
              onClick={sendMessage}
              className="bg-[#0066ff] px-4 rounded-xl text-white text-sm font-semibold shadow-md hover:bg-[#0b73ff]"
            >
              Send
            </button>
