        ...
        <div style={{ flex: '1 1 320px', padding: '28px 32px', display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', zIndex: 1 }}>
          <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }}>
            ...
            <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '0.85rem', marginTop: '8px', maxWidth: '380px' }}>
              Partnered with <strong style={{ color: '#4ade80' }}>Sai Infotech</strong> — India's leading certified e-waste recycler since 2010
            </p>
            ...
            <div style={{ marginTop: '20px', background: 'rgba(255,255,255,0.07)', borderRadius: '12px', padding: '16px 20px', borderLeft: '4px solid #4ade80' }}>
              <h2 style={{ color: '#4ade80', fontSize: "1.05rem", fontWeight: 800, marginBottom: "8px", textTransform: 'uppercase', letterSpacing: '0.08em' }}>About Sai Infotech</h2>
              <p style={{ color: 'rgba(255,255,255,0.8)', fontSize: "0.95rem", lineHeight: 1.7, margin: 0 }}>
                <strong style={{ color: '#fff' }}>Sai Infotech</strong> is a leading E-Waste Management Company specializing in IT Asset Disposition, Asset Remarketing, Secure Data Destruction, Logistics and Sustainable Recycling Services across India. Established in 2010, Sai Infotech brings over <strong style={{ color: '#4ade80' }}>20 years of industry expertise</strong> in environmentally responsible recycling and IT asset lifecycle management.
              </p>
            </div>
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: '48px 24px 0' }}>
        ...
        <div style={{ marginTop: '48px' }}>
          <SectionRef>
            <div style={{ background: 'linear-gradient(135deg, #0f172a, #14532d)', borderRadius: '18px', padding: '36px', color: '#fff' }}>
              ...
              <p style={{ color: 'rgba(255,255,255,0.6)', textAlign: 'center', marginBottom: '28px', fontSize: '0.88rem' }}>Sai Infotech follows the globally accepted 6R framework</p>
        ...
        <motion.div
          ...
          <p style={{ opacity: 0.85, maxWidth: '560px', margin: '0 auto', lineHeight: 1.7, fontSize: '0.9rem' }}>
            Sai Infotech is committed to providing safe, secure and environmentally responsible E-Waste management solutions while helping organizations achieve sustainability goals and regulatory compliance.
          </p>
        </motion.div>
