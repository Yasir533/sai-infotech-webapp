...
export default function OrbitalServices() {
  ...
  const radius = useMemo(() => (isMobile ? 145 : 270), [isMobile])

  const SIZE = useMemo(() => (isMobile ? 380 : 740), [isMobile])

  const CX = SIZE / 2
  const CY = SIZE / 2

  return (
    <div className="relative flex items-center justify-center w-full overflow-hidden px-2 md:px-6 py-10">
        ...
        {services.map((service, index) => {
          ...
          return (
            ...
            >
              ...
              <div className="w-[80px] md:w-[120px] bg-[#081120]/90 border border-cyan-400/20 rounded-xl p-2 backdrop-blur-xl shadow-[0_0_15px_rgba(0,255,255,0.08)] hover:border-cyan-400/60 hover:scale-105 transition-all duration-300">
