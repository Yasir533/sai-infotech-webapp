  ...
  return (
    <motion.nav
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        scrolled ? 'glass shadow-lg shadow-black/30 py-2' : 'py-3'
      }`}
    >
          ...
          >
            <img
              ...
              className={`w-auto object-contain transition-all duration-300 group-hover:opacity-90 group-hover:scale-105 ${
                scrolled ? 'h-12 sm:h-14' : 'h-14 sm:h-16 lg:h-20'
              }`}
              style={{
                maxWidth: '260px',
                filter: 'drop-shadow(0 0 10px rgba(6,182,212,0.5)) drop-shadow(0 0 4px rgba(37,99,235,0.4))',
              }}
            />
          </a>
